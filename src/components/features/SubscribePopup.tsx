        ...
        <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
            ...
            >
                ...
                <div className="relative z-10 p-8 md:p-10 flex flex-col items-center text-center">
                    ...
                    <button
                        onClick={handleDismiss}
                        className="absolute top-4 right-4 text-[#8A8A8A] border-none bg-transparent outline-none focus:outline-none focus-visible:outline-none hover:text-[#111] transition-colors p-2"
